...
function HomePage() {
    ...
    const handleSubmit = (e) => {
        ...
        if (trimmedInput) {
            ...
            if (watchList.some(movie => movie.title.toLowerCase() === trimmedInput.toLowerCase())) {
                alert("This movie is already in your watchlist!");
                return;
            }
            setWatchList([...watchList, { id: uuidv4(), title: trimmedInput }]);
            setInput("");
        }
    };
    ...
    const handleEdit = (id) => {
        try {
            ...
            const newMovieName = prompt("Edit name:", movie.title || "");
